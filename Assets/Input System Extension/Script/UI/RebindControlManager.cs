...
public class RebindControlManager : MonoBehaviour
{
    ...
    [Header("Events")]
    [SerializeField] private InteractiveRebindEvent onRebindStart; // Event fired when a rebind operation starts.
    [Space(5)]
    [SerializeField] private InteractiveRebindEvent onRebindStop; // Event fired when a rebind operation stops (completed or canceled).
    [Space(5)]
    [SerializeField] private UpdateBindingUIEvent onUpdateBindingUI; // Event triggered when UI should refresh.
